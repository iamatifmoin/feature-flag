  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-12">
      <div className="w-full max-w-2xl rounded-[2rem] border border-white/70 bg-white/90 p-8 shadow-panel backdrop-blur sm:p-10">
        ...
        <h1 className="mt-4 font-[var(--font-heading)] text-3xl font-semibold text-graphite">
          Create your feature-check account
        </h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          Already have access?{" "}
          <Link className="font-semibold text-sunset hover:text-violetink" href="/login">
            Sign in instead
          </Link>
          .
        </p>
